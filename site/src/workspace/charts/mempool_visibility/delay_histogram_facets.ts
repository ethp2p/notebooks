...
export default defineChart({
  id: 'delay-histogram-facets',
  topic: 'mempool-visibility',
  title: 'Post-inclusion delay distribution by transaction type',
  description:
    'Bar histogram of post-inclusion delay (ms after inclusion) per transaction type, using log-scale time buckets.',
  queries: ['mempool_events'] as const,
  related: ['delay-percentile-lines', 'age-histogram-facets'],
  context: () =>
    import(
      '../context/mempool_visibility/delay_histogram_facets.md?raw'

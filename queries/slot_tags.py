...
TAG_ORDERS: dict[str, list[str]] = {
    ...
    "first_col_proposal_tag": [NO_BLOBS, EARLY_PROPOSAL, NEUTRAL_PROPOSAL, AGGRESSIVE_PROPOSAL, LATE_PROPOSAL],
    "last_col_proposal_tag": [NO_BLOBS, EARLY_PROPOSAL, NEUTRAL_PROPOSAL, AGGRESSIVE_PROPOSAL, LATE_PROPOSAL],
    "col_first_seen_p50_tag": [NO_BLOBS, COL_FIRST_SEEN_MISSED, COL_ARRIVAL_BEFORE_4S, COL_ARRIVAL_AT_4S, COL_ARRIVAL_OVER_4S, COL_ARRIVAL_LATE],
    "col_first_seen_p90_tag": [NO_BLOBS, COL_FIRST_SEEN_MISSED, COL_ARRIVAL_BEFORE_4S, COL_ARRIVAL_AT_4S, COL_ARRIVAL_OVER_4S, COL_ARRIVAL_LATE],
    "col_first_seen_p95_tag": [NO_BLOBS, COL_FIRST_SEEN_MISSED, COL_ARRIVAL_BEFORE_4S, COL_ARRIVAL_AT_4S, COL_ARRIVAL_OVER_4S, COL_ARRIVAL_LATE],
    "col_first_seen_p99_tag": [NO_BLOBS, COL_FIRST_SEEN_MISSED, COL_ARRIVAL_BEFORE_4S, COL_ARRIVAL_AT_4S, COL_ARRIVAL_OVER_4S, COL_ARRIVAL_LATE],

    "col_spread_p50_tag": [NO_BLOBS, *_PROPAGATION_SPREAD_ORDER],
    "col_spread_p90_tag": [NO_BLOBS, *_PROPAGATION_SPREAD_ORDER],
    "col_spread_p95_tag": [NO_BLOBS, *_PROPAGATION_SPREAD_ORDER],
    "col_spread_p99_tag": [NO_BLOBS, *_PROPAGATION_SPREAD_ORDER],
